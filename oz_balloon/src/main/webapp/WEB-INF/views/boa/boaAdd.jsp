...
<body id="page-top">
    ...
    <section class="page-section" id="contact">
        <div class="container">
            ...
            <form action = "${pageContext.request.contextPath}/boa/add.do" method="post" enctype="multipart/form-data">
<!--             <input type="hidden" name="boaNo" /> -->

            <table border="1">
               <tbody>
        
                  <tr><th>제목</th><td><input type="text" name="boaTitle" style="width: 825px;"/></td></tr>
                  <tr><th>내용</th><td><textarea name="boaContent" rows="30" cols="100"></textarea></td></tr> 
