...
<body id="page-top">
    ...
    <section class="page-section" id="contact">
        <div class="container">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">고객센터</h2>
            <!-- Icon Divider-->
            ...
            <a href="${pageContext.request.contextPath}/boa/add.do">새글쓰기</a>

            <table border="1" align='center'>
                <thead>
                    <tr style="background-color: #edf2f1;">
                        <th>글번호</th>
                        <th>제목</th>
                        <th>작성자</th>
                        <th>등록일</th>
                ...
                <tbody>
			<c:forEach var="vo" items="${boaList}" varStatus="status">	

			<tr>
			<td>${status.count}</td>
			<td><a href='${pageContext.request.contextPath}/boa/edit.do?boaNo=${vo.boaNo}'>
			<c:out value="${vo.boaTitle}"></c:out> </a></td>
			<td><c:out value="${vo.boaId}"></c:out></td>
			<td><fmt:formatDate value="${vo.boaDate}" pattern= "yyyy/MM/dd hh:mm:ss" /></td>
