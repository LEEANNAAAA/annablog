...
<!--             <input type="hidden" name="boaNo" /> -->

            <table border="1">
               <tbody>
        
                  <tr><th>제목</th><td><input type="text" name="freeTitle" value="${freeVo.freeTitle}" style="width: 825px;"/></td></tr>
                  <tr><th>내용</th><td><textarea name="freeContent" rows="30" cols="100">${freeVo.freeContent}</textarea></td></tr> 
				  <tr><th>가격</th><td><input type="text" name="freePrice" value="${freeVo.freePrice}"/><br></td></tr>
				  <tr><th>작성자</th><td><c:out value="${freeVo.freeId}"></c:out><br></td></tr>
...
<!--                   <tr><th>등록일</th><td>2020-07-16</td></tr> -->
               ...
               <a href='${pageContext.request.contextPath}/free/del.do?freeNo=${freeVo.freeNo}'><input type="button" value="삭제"/></a></span>
