    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
      ...
      <section class="page-section" id="contact">
        <div class="container">
           ...
           <a href="${pageContext.request.contextPath}/free/add.do">새글쓰기</a>
            ...
            <table  border="1" align='center'>
                ...
                <tbody>
               <c:forEach var="vo" items="${freeList}" varStatus="status">	

			<tr>
			<td>${status.count}</td>
			<td><a href='${pageContext.request.contextPath}/free/edit.do?freeNo=${vo.freeNo}'>
			<c:out value="${vo.freeTitle}"></c:out> </a></td>
			<td><c:out value="${vo.freeId}"></c:out></td>
			<td><c:out value="${vo.freePrice}"></c:out></td>
