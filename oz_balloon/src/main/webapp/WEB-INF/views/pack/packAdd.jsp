	...
	<br>
	  ...
	  <section class="page-section" id="contact">
        <div class="container">
           ...
           <form action = "${pageContext.request.contextPath}/pack/add.do" method="post" enctype="multipart/form-data">
            ...
            <table border="1">
               <tbody>
                  ...
                  <tr><th>제목</th><td><input type="text" name="packTitle" style="width: 825px;"/></td></tr>
                  <tr><th>내용</th><td><textarea name="packContent" rows="30" cols="100"></textarea></td></tr> 
				  <tr><th>가격</th><td><input type="text" name="packPrice"/><br></td></tr>
