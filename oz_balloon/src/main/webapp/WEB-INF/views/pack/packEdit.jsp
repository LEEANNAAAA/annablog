...
<body id="page-top">
	...
	<br>
        ...
        <div class="container">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">패키지여행</h2>
            <!-- Icon Divider-->
            ...
            <!-- Contact Section Form-->
           	...
           	<h1>글 상세정보</h1>
            <form action = "${pageContext.request.contextPath}/pack/edit.do" method="post">
            	<input type="hidden" name="packNo" value="${packVo.packNo}" />

            <table border="1">
               <tbody>
        
                  <tr><th>제목</th><td><input type="text" name="packTitle" value="${packVo.packTitle}" style="width: 825px;"/></td></tr>
                  <tr><th>내용</th><td><textarea name="packContent" rows="30" cols="100">${packVo.packContent}</textarea></td></tr> 
				  <tr><th>가격</th><td><input type="text" name="packPrice" value="${packVo.packPrice}"/><br></td></tr>
				  <tr><th>작성자</th><td><c:out value="${packVo.packId}"></c:out><br></td></tr>
...
<!--                   <tr><th>작성자</th><td> ss</td></tr>  -->
<!--                   <tr><th>등록일</th><td>2020-07-16</td></tr> -->
               </tbody>
            </table>
               <br>
               <span style="float:right"> <input type="submit" value="저장" />
               <a href='${pageContext.request.contextPath}/pack/del.do?packNo=${packVo.packNo}'><input type="button" value="삭제"/></a></span>
