    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
      ...
      <section class="page-section" id="contact">
        <div class="container">
           ...
           <a href="${pageContext.request.contextPath}/pack/add.do">새글쓰기</a>
            ...
            <table  border="1" align='center'>
                ...
                <tbody>
               <c:forEach var="vo" items="${packList}" varStatus="status">	

			<tr>
			<td>${status.count}</td>
			<td><a href='${pageContext.request.contextPath}/pack/edit.do?packNo=${vo.packNo}'>
			<c:out value="${vo.packTitle}"></c:out> </a></td>
			<td><c:out value="${vo.packId}"></c:out></td>
			<td><c:out value="${vo.packPrice}"></c:out></td>
